...
class ProjectsController < ApplicationController
  ...
  def bitly
    require 'net/http'
    res = Net::HTTP.start("api.bit.ly", 80) { |http| http.get("/v3/shorten?login=diogob&apiKey=R_61725148ac416a0faeaca4faba1a9090&longUrl=#{CGI.escape(project_url(@project))}") }
