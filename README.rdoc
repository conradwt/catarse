== Catarse
   ...
   Note:  This fork is being developed by Conrad Taylor for the site, {smartn.me}[http://smartn.me].
...
You can see the software in action on http://smartn.me as well as http://catarse.me.
...
Currently, we only support Paypal, which is a world wide payment gateway. We need to create different options of payment gateways so each site can chose which gateways to use.
...
We currently have a great blog post in Portuguese, written by Relsi Hur Maron, with a step-by-step guide on how to run and start developing Catarse on your environment. Check it on http://www.tuxtilt.com/catarse-plataforma-de-crowdfunding-open-source and have fun!  Also, {smartn.me}[http://blog.smartn.me] has a great blog.
...
Forked by:  Conrad Taylor

== License

Copyright (c) 2011 Softa

Copyright (c) Conrad Taylor
